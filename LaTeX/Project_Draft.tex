...
Where \textalpha \: and \textGamma \: are 2 \times 1 constant vectors, \textbeta \: is a 2 x 2 constant matrix, and \textepsilon \: is a 2 x 1 random vector with zero mean. 
...
\textbeta\textunderscore{1} and \textbeta\textunderscore{2} are the positive and negatve roots of the quadratic equation. 
...
\begin{table}%[ht] or say [H]
	\centering
	\begin{tabular}{cccccc} % each column is centered (else could have left aligned [l] or right [r])
		\toprule			
...
\begin{figure}
	\includegraphics[width=\columnwidth]{img/OMP.png}
	\caption{Monetary Policy Figures}
	\label{fig:myf2}
\end{figure}

\begin{figure}
	\includegraphics[width=\columnwidth]{img/Entry_Exit.pdf}
	\caption{Entry Exit Figures}
	\label{fig:myf3}
\end{figure}
\pagebreak
\bibliographystyle{ecca}
